...
describe('ArchievementComponent', () => {
  ...
  it('should add the description meta tag', () => {
    const descriptionTag:any = meta.getTag('name="achievment_description"');
